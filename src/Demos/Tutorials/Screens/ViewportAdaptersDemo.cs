...
{
    public class ViewportAdaptersScreen : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            _boxingViewportAdapter = new BoxingViewportAdapter(Game.Window, GraphicsDevice, 800, 480);//, 88, 70);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                GraphicsDevice.Viewport = new Viewport(0, 0, Game.Window.ClientBounds.Width, Game.Window.ClientBounds.Height);
